 ...
 * or string ID to see if referencing same container.
 *
...
Container.prototype.equal = function(id) {
  if (id instanceof Container) id = id.id;

  if (this.id.length === id.length) {
    return this.id === id;
  } else if (this.id.length > id.length) {
